...
export default function ResizeStep(eventBus, taskResizingEnabled) {
  RuleProvider.call(this, eventBus);
  this.taskResizingEnabled=taskResizingEnabled || false;
}

inherits(ResizeStep, RuleProvider);

ResizeStep.$inject = [ 'eventBus', 'config.taskResizingEnabled' ];

ResizeStep.prototype.init = function() {
  var me=this;
